...
export function validateString(
  raw: unknown,
  opts: { maxLength: number; field?: string; pattern?: RegExp }
 ...
 */
export function validateRunId(raw: unknown): ValidateResult<string> {
 ...
 */
export function validateRecord(raw: unknown, maxValueLength: number = 10_000): ValidateResult<Record<string, string>> {
